...
const utils_1 = require("@tigeuplus/utility");
/**
 * 전송 데이터
 *
 * @since v1.0.0
...
privatekey) {
    try {
        transfer.signature = '';
        return (0, utils_1.stringify)(new elliptic_1.ec('secp256k1').keyFromPrivate(privatekey).sign((0, utils_1.stringify)(transfer)));
    }
    catch (error) { }
}
...
transfer) {
    ...
    transfer.signature = '';
    return new elliptic_1.ec('secp256k1').keyFromPublic(transfer.from, 'hex').verify((0, utils_1.stringify)(transfer), signature);
}
